  ...
  var i = (function () {
    function t() {
      ...
      if (
        ...
        i.addEventListener("touchstart", n, r),
          i.addEventListener("touchmove", s, r),
      ...
      (t.prototype._touchstart = function (e) {
        ...
        if (this._shouldHandle(e)) {
          if (
            ...
            return e.cancelable && e.preventDefault(), void this._reset();
          this._reset();
      ...
      (t.prototype._touchmove = function (t) {
        if (this._shouldCancelPressHoldMove(t)) this._reset();
          ...
          if (this._dispatchEvent(t, "mousemove", e))
            return (
              (this._lastTouch = t), void (t.cancelable && t.preventDefault())
            );
          this._dragSource &&
            !this._img &&
